...
import { Reply, FileText, X } from "lucide-react";
                        ...
                        <div className="flex flex-col max-w-[80%] sm:max-w-xs items-start">
                            ...
                            <div className="relative z-10 bg-white text-black break-words px-4 py-3 text-[15px] shadow-sm rounded-[24px] rounded-bl-[4px]">
                                ...
                                {message.attachment_url && message.attachment_type === 'image' && (
                                    <div
                                        className="relative mb-2 -mx-1 overflow-hidden rounded-[16px] bg-black/5 shadow-sm mt-1 cursor-pointer group/img"
                                        onClick={openLightbox}
                                    >
                                        <img
                                            src={message.attachment_url}
                                            alt="attachment"
                                            className="w-full max-h-[250px] object-cover transition-transform duration-700 ease-out group-hover/img:scale-[1.03]"
                                            draggable={false}
                                        />
